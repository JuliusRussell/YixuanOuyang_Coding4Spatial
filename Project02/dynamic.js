...
(function() {
    ...
    cacheFn = function(func) {
        ...
        return function() {
            ...
            key = "";
            for (_i = 0,
            _len = arguments.length; _i < _len; _i++) {
                k = arguments[_i];
                key += k.toString() + ",";
            }
            result = data[key];
        ...
        return function(el) {
            ...
            if (el instanceof Array || el instanceof NodeList || el instanceof HTMLCollection) {
                res = (function() {
                    ...
                    _results = [];
                    for (i = _i = 0,
                    _ref = el.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    createInterpolable = function(value) {
        ...
        for (_i = 0,
        _len = klasses.length; _i < _len; _i++) {
            klass = klasses[_i];
    ...
    InterpolableString = (function() {
        ...
        InterpolableString.prototype.interpolate = function(endInterpolable, t) {
            ...
            newParts = [];
            for (i = _i = 0,
            _ref = Math.min(start.length, end.length); 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        InterpolableString.create = function(value) {
            ...
            index = 0;
            for (_j = 0,
            _len1 = matches.length; _j < _len1; _j++) {
                match = matches[_j];
    ...
    DecomposedMatrix2D = (function() {
        ...
        DecomposedMatrix2D.prototype.interpolate = function(endMatrix, t) {
            ...
            _len = _ref.length; _i < _len; _i++) {
                ...
                newProps[k] = [];
                for (i = _j = 0,
                _ref1 = this.props[k].length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
            ...
            _ref2 = ['skew'];
            for (_l = 0,
            _len1 = _ref2.length; _l < _len1; _l++) {
                k = _ref2[_l];
    ...
    Matrix2D = (function() {
        ...
        Matrix2D.prototype.applyProperties = function(properties) {
            ...
            hash = {};
            for (_i = 0,
            _len = properties.length; _i < _len; _i++) {
                props = properties[_i];
    ...
    Vector = (function() {
        ...
        Vector.prototype.combine = function(b, ascl, bscl) {
            ...
            result = [];
            for (i = _i = 0,
            _ref = this.els.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    DecomposedMatrix = (function() {
        ...
        DecomposedMatrix.prototype.interpolate = function(decomposedB, t, only) {
            ...
            _len = _ref.length; _i < _len; _i++) {
                ...
                decomposed[k] = [];
                for (i = _j = 0,
                _ref1 = decomposedA[k].length - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
    ...
    prefixFor = cacheFn(function(property) {
        ...
        propertyName = "";
        for (_i = 0,
        _len = propArray.length; _i < _len; _i++) {
            prop = propArray[_i];
    ...
    runLoopTick = function(t) {
        ...
        toRemoveAnimations = [];
        for (_i = 0,
        _len = animations.length; _i < _len; _i++) {
    ...
    observeVisibilityChange(function(visible) {
        ...
        if (!visible) {
            ...
            _results = [];
            for (_i = 0,
            _len = timeouts.length; _i < _len; _i++) {
                timeout = timeouts[_i];
            ...
            if (runLoopRunning) {
                ...
                for (_j = 0,
                _len1 = animations.length; _j < _len1; _j++) {
            ...
            for (_k = 0,
            _len2 = timeouts.length; _k < _len2; _k++) {
                timeout = timeouts[_k];
